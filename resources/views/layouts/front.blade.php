    ...
    <nav class="megamenu navbar navbar-default">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"><img src="{{ asset('front/images/logos/logo.png') }}" alt="image"></a>
            </div>
...
<div id="about" class="section wb">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="post-media wow fadeIn">
                    <img src="{{ asset('front/uploads/about_01.jpg') }}" alt="" class="img-responsive img-rounded">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="post-media wow fadeIn">
                    <img src="{{ asset('front/uploads/about_02.jpg') }}" alt="" class="img-responsive img-rounded">
                </div><!-- end media -->
            </div><!-- end col -->
        ...
        <div class="owl-services owl-carousel owl-theme">
            <div class="service-widget">
                <div class="post-media wow fadeIn">
                    ...
                    <img src="{{ asset('front/uploads/service_01.jpg') }}" alt="" class="img-responsive img-rounded">
                </div>
            ...
            <div class="service-widget">
                <div class="post-media wow fadeIn">
                    ...
                    <img src="{{ asset('front/uploads/service_02.jpg') }}" alt="" class="img-responsive img-rounded">
                </div>
                <div class="service-dit">
            ...
            <div class="service-widget">
                <div class="post-media wow fadeIn">
                    ...
                    <img src="{{ asset('front/uploads/service_03.jpg') }}" alt="" class="img-responsive img-rounded">
                </div>
                <div class="service-dit">
            ...
            <div class="service-widget">
                <div class="post-media wow fadeIn">
                    ...
                    <img src="{{ asset('front/uploads/service_04.jpg') }}" alt="" class="img-responsive img-rounded">
                </div>
                <div class="service-dit">
        ...
        <div class="row text-center">
            ...
            <div class="col-md-6">
                <div class="text-center image-center hidden-sm hidden-xs">
                    <img src="{{ asset('front/uploads/device_03.png') }}" alt="" class="img-responsive wow fadeInUp">
                </div>
            </div>
        </div><!-- end row -->
    </div><!-- end container -->
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 hidden-xs hidden-sm">
                <img src="{{ asset('front/uploads/ipad.png') }}" class="img-center img-responsive" alt="">
            </div>
            <div class="col-md-4 col-sm-6 col-xs-12">
    ...
    <div class="container">
                ...
                <div class="testi-carousel owl-carousel owl-theme">
                    <div class="testimonial clearfix">
                        ...
                        <div class="testi-meta">
                            <img src="{{ asset('front/uploads/testi_01.pn') }}g" alt="" class="img-responsive alignleft">
                    ...
                    <div class="testimonial clearfix">
                        ...
                        <div class="testi-meta">
                            <img src="{{ asset('front/uploads/testi_02.png') }}" alt="" class="img-responsive alignleft">
                    ...
                    <div class="testimonial clearfix">
                        ...
                        <div class="testi-meta">
                            <img src="{{ asset('front/uploads/testi_03.png') }}" alt="" class="img-responsive alignleft">
                    ...
                    <div class="testimonial clearfix">
                        ...
                        <div class="testi-meta">
                            <img src="{{ asset('front/uploads/testi_01.png') }}" alt="" class="img-responsive alignleft">
                            <h4>James Fernando <small>- Manager of Racer</small></h4>
                        </div>
                        <!-- end testi-meta -->
                    </div>
        ...
        <div class="row logos">
            <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                <a href="#"><img src="{{ asset('front/uploads/logo_01.png') }}" alt="" class="img-repsonsive"></a>
            </div>
            <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                <a href="#"><img src="{{ asset('front/uploads/logo_02.png') }}" alt="" class="img-repsonsive"></a>
            </div>
            <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                <a href="#"><img src="{{ asset('front/uploads/logo_03.png') }}" alt="" class="img-repsonsive"></a>
            </div>
            <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                <a href="#"><img src="{{ asset('front/uploads/logo_04.png') }}" alt="" class="img-repsonsive"></a>
            </div>
            <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                <a href="#"><img src="{{ asset('front/uploads/logo_05.png') }}" alt="" class="img-repsonsive"></a>
            </div>
            <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                <a href="#"><img src="{{ asset('front/uploads/logo_06.png') }}" alt="" class="img-repsonsive"></a>
            </div>
        </div><!-- end row -->
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="widget clearfix">
                    <div class="widget-title">
                        <img src="{{ asset('front/images/logos/logo-2.png') }}" alt="" />
                    </div>
